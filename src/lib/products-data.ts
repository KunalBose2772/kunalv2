...
export const productsData: Record<string, ProductDetail> = {
  "dms": {
    ...
    metaTitle: "Enterprise Document Management System (DMS) | Built by Kunal",
  ...
  "lms": {
    ...
    metaTitle: "Custom Learning Management System (LMS) | Built by Kunal",
  ...
  "hms": {
    ...
    metaTitle: "Hospital Management System (HMS) | Built by Kunal",
  ...
  "ott": {
    id: "ott",
    title: "OTT Platforms",
    metaTitle: "Custom OTT Platform Development | Built by Kunal",
    ...
    bentoFeatures: [
      {
        ...
        borderHover: "hover:border-purple-300 hover:shadow-[0_20px_50px_rgba(var(--accent-global-rgb), 0.06)]",
  ...
  "school-erp": {
    ...
    metaTitle: "School Management ERP | Built by Kunal",
  ...
  "marketplace": {
    ...
    metaTitle: "Multi-vendor Marketplace Development | Built by Kunal",
  ...
  "pos": {
    ...
    metaTitle: "Cloud Point of Sale (POS) Software | Built by Kunal",
  ...
  "crm": {
    id: "crm",
    title: "CRM System",
    metaTitle: "Custom CRM Software Development | Built by Kunal",
  ...
  "logistics": {
    ...
    metaTitle: "Logistics & Fleet Management Software | Built by Kunal",
  ...
  "inventory": {
    ...
    metaTitle: "Smart Inventory Management System | Built by Kunal",
  ...
  "ecommerce": {
    ...
    metaTitle: "Custom E-Commerce Development | Built by Kunal",
  ...
  "hrms": {
    ...
    metaTitle: "HRMS & Payroll Management Software | Built by Kunal",
