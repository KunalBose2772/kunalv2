...
export const SERVICES_MAP: Record<string, ServiceDetail> = {
  web: {
    ...
    metaTitle: "Custom Web Application Development Services | Built by Kunal",
  ...
  mobile: {
    ...
    metaTitle: "iOS & Android Mobile App Development Company | Built by Kunal",
  ...
  saas: {
    ...
    metaTitle: "Custom SaaS Platform Development Services | Built by Kunal",
    ...
    iconName: "saas",
    accent: "var(--accent-global)",
    gradient: "rgba(var(--accent-global-rgb), 0.15)",
    features: [
  ...
  ai: {
    ...
    metaTitle: "Enterprise AI & Machine Learning Services | Built by Kunal",
  ...
  cloud: {
    ...
    metaTitle: "Enterprise Cloud Architecture & Migration | Built by Kunal",
  ...
  erp: {
    ...
    metaTitle: "Custom ERP & CRM Software Development | Built by Kunal",
  ...
  devops: {
    id: "devops",
    title: "DevOps & CI/CD",
    metaTitle: "DevOps Consulting & CI/CD Automation Services | Built by Kunal",
  ...
  design: {
    id: "design",
    title: "UI/UX Design",
    metaTitle: "Premium UI/UX Design & Design Systems Agency | Built by Kunal",
  ...
  transform: {
    ...
    metaTitle: "Legacy Modernization & Digital Transformation | Built by Kunal",
  ...
  support: {
    ...
    metaTitle: "24/7 Software Maintenance & System Monitoring | Built by Kunal",
  ...
  "whatsapp-marketing": {
    ...
    metaTitle: "Enterprise WhatsApp Marketing & Chatbot Automation | Built by Kunal",
  ...
  "content-marketing": {
    ...
    metaTitle: "Premium Content Marketing & Copywriting Services | Built by Kunal",
  ...
  "seo": {
    ...
    metaTitle: "Technical SEO & Organic Growth Optimization | Built by Kunal",
  ...
  "social-media-marketing": {
    ...
    metaTitle: "Organic Social Media Growth & Brand Marketing | Built by Kunal",
  ...
  "ppc": {
    id: "ppc",
    title: "Paid Ads (PPC)",
    metaTitle: "Google Ads & Meta Advertising (PPC) Experts | Built by Kunal",
  ...
  "influencer-marketing": {
    ...
    metaTitle: "Creator Partnerships & Influencer Campaigns | Built by Kunal",
  ...
  "digital-marketing": {
    ...
    metaTitle: "Full-Scale Growth & Digital Marketing Solutions | Built by Kunal",
  ...
  "orm": {
    ...
    metaTitle: "Online Reputation Management (ORM) & PR Services | Built by Kunal",
  ...
  "3d-video-editing": {
    ...
    metaTitle: "Premium 3D Animation & Video Editing Services | Built by Kunal",
  ...
  "still-branding": {
    ...
    metaTitle: "Brand Identity, Logo Design & Style Systems | Built by Kunal",
  ...
  "performance-marketing": {
    ...
    metaTitle: "Data-Driven Performance Marketing & ROI Scaling | Built by Kunal",
  ...
  "graphic-designing": {
    ...
    metaTitle: "Premium Graphic Design & Collateral Production | Built by Kunal",
