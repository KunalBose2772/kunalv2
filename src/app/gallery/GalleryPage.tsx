            ...
            return (
              <button
                ...
                className={`px-5 py-2.5 rounded-full text-xs font-bold uppercase tracking-wider transition-all duration-300 ${
                  isActive
                    ? "bg-[var(--accent-global)] text-white shadow-[0_4px_14px_rgba(var(--accent-global-rgb), 0.3)]"
                    : "bg-white text-slate-600 hover:text-[var(--accent-global)] hover:bg-slate-50 border border-slate-200/80"
                }`}
              >
                {cat}
              </button>
                ...
                >
                  ...
                  <div className="relative aspect-[4/3] w-full overflow-hidden bg-slate-100">
                    ...
                    <div className="absolute inset-0 bg-slate-950/45 opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center">
                      <div className="w-11 h-11 rounded-full bg-white text-[var(--accent-global)] flex items-center justify-center shadow-lg transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="text-[15px] font-bold text-slate-900 font-sora leading-snug group-hover:text-[var(--accent-global)] transition-colors mb-1.5">
                      {item.title}
                    </h3>
          ...
          >
            ...
            >
              ...
              <div className="absolute top-0 inset-x-0 bg-gradient-to-b from-black/80 via-black/40 to-transparent p-6 text-white flex items-start justify-between">
                <div>
                  <span className="inline-block px-2.5 py-0.5 rounded bg-[var(--accent-global)] text-[9px] font-extrabold uppercase tracking-widest mb-1.5">
