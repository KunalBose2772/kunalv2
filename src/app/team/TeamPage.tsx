  ...
  return (
    <div className="min-h-screen bg-[#fafbfc]">
      ...
      <PageHero
        ...
        titleHighlight="Built by Kunal Engineering"
      ...
      <section className="py-24 max-w-[1400px] mx-auto px-4 sm:px-6 relative">
        <div className="absolute top-[20%] left-[-5%] w-[40%] h-[40%] bg-[radial-gradient(circle,_rgba(var(--accent-global-rgb), 0.025)_0%,_transparent_70%)] blur-[100px] pointer-events-none" />
                  ...
                  <div className="flex gap-2">
                    {member.linkedin && member.linkedin !== "#" && member.linkedin.trim() !== "" && (
                      <a
                        ...
                        className="w-8 h-8 rounded-full bg-purple-50 text-[var(--accent-global)] flex items-center justify-center hover:scale-110 hover:bg-[var(--accent-global)] hover:text-white transition-all duration-250 shadow-sm"
