  ...
  return (
    <div className="min-h-screen bg-[#fafbfc]">
      ...
      <section className="py-24 relative overflow-hidden bg-gradient-to-b from-[#fafbfc] to-slate-50 border-b border-slate-200/50">
        ...
        <div className="absolute top-[10%] left-[-5%] w-[400px] h-[400px] bg-[radial-gradient(circle,_rgba(var(--accent-global-rgb), 0.04)_0%,_transparent_75%)] blur-[100px] pointer-events-none" />
