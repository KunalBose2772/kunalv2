...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `Best IT & Software Company in ${cityData.name} | Built by Kunal`,
    description: `Looking for top-tier software development, AI solutions, and digital marketing in ${cityData.name}, ${cityData.state}? Built by Kunal delivers enterprise-grade IT services globally.`,
    alternates: {
      canonical: `https://builtbykunal.online/locations/${cityData.id}`,
    },
    openGraph: {
      ...
      url: `https://builtbykunal.online/locations/${cityData.id}`,
    },
  };
}
...
export default async function LocationPage({ params }: Props) {
  ...
  const localSchema = {
    ...
    "@type": "LocalBusiness",
    "name": `Built by Kunal - ${cityData.name}`,
