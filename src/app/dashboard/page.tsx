...
const COLORS = ["#5b5bd6","var(--accent-global)","#0891b2","#16a34a","#d97706","#ea580c","#ec4899","#6366f1"];
  ...
  return (
    <div className="space-y-7">
      ...
      <motion.div
        ...
        style={{
          background: "linear-gradient(135deg, #5b5bd6 0%, #4338ca 50%, var(--accent-global-hover) 100%)",
        }}
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard title="Conversion Rate"  value={s.conversionRate} suffix="%" change={3} icon={TrendingUp} color="var(--accent-global)" delay={0.15} />
