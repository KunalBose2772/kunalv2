...
export default function ReportsPage() {
  ...
  const handleExport = () => {
    ...
    try {
      ...
      link.setAttribute("download", `builtbykunal_crm_report_${new Date().toISOString().split("T")[0]}.csv`);
    ...
    <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {[
          ...
          { label: "Conversion Rate", value: kpis.conversionRate, change: "+3%",  icon: TrendingUp,  color: "var(--accent-global)" },
