      ...
      <PageHeader
        ...
        actions={
          <button 
            ...
            style={{ background: "linear-gradient(135deg,var(--accent-global),var(--accent-global-hover))", boxShadow: "0 1px 2px 0 rgba(var(--accent-global-rgb), 0.25)" }}>
              ...
              <form onSubmit={handleSubmit} className="space-y-4 max-h-[70vh] overflow-y-auto pr-1">
                ...
                <div className="pt-4 border-t flex justify-end gap-3" style={{ borderColor: "var(--crm-border-faint)" }}>
                  ...
                  <button type="submit" disabled={saving}
                    ...
                    style={{ background: "linear-gradient(135deg,var(--accent-global),var(--accent-global-hover))" }}>
