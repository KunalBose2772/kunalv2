      ...
      <PageHeader
        ...
        actions={
          <button 
            ...
            style={{ background: "linear-gradient(135deg,#5b5bd6,var(--accent-global))", boxShadow: "0 1px 2px 0 rgba(91,91,214,0.25)" }}>
              ...
              <form onSubmit={handleSubmit} className="space-y-4 max-h-[70vh] overflow-y-auto pr-1">
                ...
                <div>
                  ...
                  <textarea required rows={4} value={form.description} onChange={e => setForm({...form, description: e.target.value})}
                    placeholder="Outline the case study summary and what Built by Kunal engineered..." className="w-full bg-slate-500/5 border rounded-lg px-3 py-2 text-sm outline-none focus:border-purple-500 resize-none font-medium" style={{ borderColor: "var(--crm-border)", color: "var(--crm-text)" }} />
                </div>
                ...
                <div className="pt-4 border-t flex justify-end gap-3" style={{ borderColor: "var(--crm-border-faint)" }}>
                  ...
                  <button type="submit" disabled={saving}
                    ...
                    style={{ background: "linear-gradient(135deg,#5b5bd6,var(--accent-global))" }}>
