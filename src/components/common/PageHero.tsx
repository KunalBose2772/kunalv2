...
export default function PageHero({
  ...
  return (
    <section
      ...
      style={{
        background: isDark
          ? "radial-gradient(circle at 80% 20%, #9333ea 0%, var(--accent-global) 55%, #5b21b6 100%)"
          : "radial-gradient(circle at 80% 20%, rgba(var(--accent-global-rgb), 0.05) 0%, rgba(var(--accent-global-rgb), 0.01) 50%, transparent 100%), #f8fafc",
      ...
      <div
        ...
        style={{
          backgroundImage: isDark
            ...
            : "radial-gradient(var(--accent-global) 1px, transparent 1px)",
