  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: `linear-gradient(160deg, ${accentColor} 0%, #4338ca 60%, var(--accent-global-hover) 100%)`,
        }}
      >
        {/* Decorative blobs */}
        <div
        ...
        <div className="relative flex items-center gap-2.5">
          ...
          <div>
            <p className="text-[14px] font-semibold text-white leading-tight">Built by Kunal</p>
        ...
        <div className="relative">
          ...
          >
            <p className="text-[13px] text-white/90 leading-relaxed">
              &ldquo;We replaced three tools with Built by Kunal CRM. Our lead conversion improved by 38% in the first quarter.&rdquo;
            </p>
        ...
        >
          ...
          <div className="lg:hidden flex items-center gap-2.5 mb-8">
            <div className="w-9 h-9 rounded-xl flex items-center justify-center"
              style={{ background: `linear-gradient(135deg,${accentColor},var(--accent-global))` }}>
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            ...
            <motion.button
              ...
              style={{
                background: `linear-gradient(135deg, ${accentColor} 0%, var(--accent-global-hover) 100%)`,
