              ...
              <div className="w-full flex flex-col md:flex-row relative">
                  ...
                  <div className="space-y-5">
                    ...
                    {flowType === "package" && (
                      <span 
                        ...
                        style={{
                          background: "var(--accent-global-dim, rgba(var(--accent-global-rgb), 0.08))",
                          color: "var(--accent-global)",
                          border: "1px solid color-mix(in srgb, var(--accent-global) 25%, transparent)"
                        }}
                      >
                    ...
                    <h2 className="text-3xl sm:text-4xl font-extrabold font-sora text-slate-900 tracking-tight leading-tight">
                      {flowType === "package" && (
                        <>
                          Configure & Secure the <span style={{ color: "var(--accent-global)" }}>{preselectedPackage}</span>.
                        </>
                      )}
                      {flowType === "quote" && (
                        <>
                          Finalize and submit your <span style={{ color: "var(--accent-global)" }}>custom configuration</span>.
                        </>
                      )}
                      {flowType === "general" && (
                        <>
                          Let&apos;s start building your <span style={{ color: "var(--accent-global)" }}>next big product</span>.
                        </>
                      )}
                    </h2>
                    ...
                    <div className="flex flex-wrap items-center gap-4 pt-3">
                      <button
                        ...
                        style={{ 
                          ...
                          boxShadow: "0 8px 24px rgba(var(--accent-global-rgb), 0.25)"
                        }}
                        onMouseEnter={(e) => {
                          e.currentTarget.style.background = "var(--accent-global-hover, var(--accent-global-hover))";
                        }}
                        onMouseLeave={(e) => {
                      ...
                      <div className="flex items-center gap-2 bg-slate-50 border border-slate-100 px-4 py-2 rounded-full text-xs font-semibold text-slate-600">
                        <Clock className="w-4 h-4" style={{ color: "var(--accent-global)" }} />
                ...
                <div className="hidden md:block w-full md:w-[380px] bg-gradient-to-tr from-purple-100/50 via-slate-50 to-indigo-50/30 relative min-h-[350px] md:min-h-full overflow-hidden shrink-0 border-l border-slate-100/60">
                  ...
                  <motion.div
                    ...
                    className="absolute top-[26%] left-4 z-10 bg-white/90 backdrop-blur-md border border-white/60 shadow-[0_8px_30px_rgba(var(--accent-global-rgb), 0.06)] rounded-2xl px-4 py-2 flex items-center gap-2.5 max-w-[170px]"
                  >
                  ...
                  <motion.div
                    ...
                    className="absolute bottom-[28%] right-4 z-10 bg-white/90 backdrop-blur-md border border-white/60 shadow-[0_8px_30px_rgba(var(--accent-global-rgb), 0.06)] rounded-2xl px-4 py-2 flex items-center gap-2.5 max-w-[170px]"
                  >
                          ...
                          <div className="grid sm:grid-cols-3 gap-3">
                            {[
                              ...
                              <button
                                ...
                                style={{
                                  borderColor: form.budget === tier.val ? "var(--accent-global)" : "",
                                  boxShadow: form.budget === tier.val ? "0 4px 12px rgba(var(--accent-global-rgb), 0.08)" : "",
                                }}
                              >
                ...
                {leadId && (
                  <div className="inline-block px-4 py-2 bg-slate-50 border border-slate-100 rounded-xl mb-8">
                    <p className="text-xs font-mono text-slate-500">
                      Solution Blueprint Reference Code: <span style={{ color: "var(--accent-global)" }} className="font-bold">{leadId}</span>
                    </p>
                  </div>
                )}
