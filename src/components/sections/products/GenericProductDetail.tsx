...
export default function GenericProductDetail({ product }: { product: ProductDetail }) {
  ...
  const testimonials = [
    {
      quote: `Built by Kunal ${product.title} transformed how our team handles daily workflows. We scaled our operations 4x faster and maintain perfect data compliance. Truly the best system we have ever deployed.`,
      name: "Sarah Jenkins",
      ...
      <section className="py-20 sm:py-24 bg-white relative overflow-visible">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 relative overflow-visible">
          ...
          <div className="max-w-3xl mb-12 sm:mb-16">
            ...
            >
              Get Started with Built by Kunal {product.title} <br />
