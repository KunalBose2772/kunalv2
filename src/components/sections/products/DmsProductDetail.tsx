...
const dmsTestimonials = [
  {
    quote: "Built by Kunal DMS transformed the way our team processes invoices. We close approval cycles 4x faster and maintain perfect audit trails for compliance. Truly the best system we have ever deployed.",
    name: "Sarah Jenkins",
  ...
  return (
    <div className="min-h-screen text-[var(--text-secondary)] bg-[var(--bg-primary)] relative" style={customStyles}>
      ...
      <ProductHero
        ...
        description="Secure. Organize. Collaborate. Access your critical documents anytime, anywhere with Built by Kunal DMS."
      ...
      <section className="py-20 sm:py-24 bg-white relative overflow-visible">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 relative overflow-visible">
          ...
          <div className="max-w-3xl mb-12 sm:mb-16">
            ...
            >
              Get Started with Built by Kunal DMS <br />
