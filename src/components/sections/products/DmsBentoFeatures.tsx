...
export default function DmsBentoFeatures() {
  const features = [
    ...
    },
    {
      ...
      borderHover: "hover:border-violet-300 hover:shadow-[0_20px_50px_rgba(var(--accent-global-rgb), 0.06)]",
      ...
      <div className="relative mx-auto max-w-[1400px] px-6 z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-3 text-slate-500 text-sm leading-relaxed max-w-xl mx-auto font-medium" style={{ fontFamily: "'Inter', sans-serif" }}>
            Built by Kunal DMS simplifies how teams manage documents, protect sensitive data, and accelerate workflows.
          </p>
        </div>
