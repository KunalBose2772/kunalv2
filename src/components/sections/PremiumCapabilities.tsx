  ...
  switch (id) {
    case "web":
      return {
        ...
        cardTitle: "Built by Kunal Web Engine",
        icon: Code2,
    ...
    case "mobile":
      return {
        ...
        cardTitle: "Built by Kunal Mobile Dev",
        icon: Smartphone,
    ...
    case "saas":
      return {
        ...
        cardTitle: "Built by Kunal SaaS Core",
        icon: Layers,
        wideGradient: "from-[#4C1D95] to-[var(--accent-global)]",
    ...
    case "ai":
      return {
        ...
        cardTitle: "Built by Kunal AI Agent",
        icon: Cpu,
        wideGradient: "from-[#991B1B] to-[#EF4444]",
        squareGradient: "from-[var(--accent-global)] to-[var(--accent-global)]"
      };
    case "cloud":
      return {
        ...
        cardTitle: "Built by Kunal Cloud Node",
        icon: Database,
    ...
    case "devops":
      return {
        ...
        cardTitle: "Built by Kunal CI/CD Pipeline",
        icon: Settings,
    ...
    case "erp":
      return {
        ...
        cardTitle: "Built by Kunal ERP Engine",
        icon: Layers,
    ...
    case "whatsapp-marketing":
      return {
        ...
        cardTitle: "Built by Kunal WA Bot",
        icon: MessageSquare,
    ...
    case "social-media-marketing":
      return {
        ...
        cardTitle: "Built by Kunal Social",
        icon: MessageSquare,
    ...
    case "3d-video-editing":
      return {
        ...
        cardTitle: "Built by Kunal Studio",
        icon: Layers,
    ...
    case "graphic-designing":
      return {
        ...
        cardTitle: "Built by Kunal Graphics",
        icon: Layers,
    ...
    case "seo":
      return {
        ...
        cardTitle: "Built by Kunal SEO Core",
        icon: Globe,
        wideGradient: "from-[#1E3A8A] to-[#1D4ED8]",
        squareGradient: "from-[var(--accent-global)] to-[var(--accent-global)]"
      };
    case "dms":
      return {
        ...
        cardTitle: "Built by Kunal DMS Platform",
        icon: ShieldCheck,
    ...
    case "lms":
      return {
        ...
        cardTitle: "Built by Kunal LMS Core",
        icon: Briefcase,
    ...
    case "hms":
      return {
        ...
        cardTitle: "Built by Kunal HMS Node",
        icon: ShieldCheck,
    ...
    case "ott":
      return {
        ...
        cardTitle: "Built by Kunal OTT Stream",
        icon: Smartphone,
        wideGradient: "from-[var(--accent-global-hover)] to-[var(--accent-global)]",
        squareGradient: "from-[#10B981] to-[#059669]"
      };
    case "school-erp":
      return {
        ...
        cardTitle: "Built by Kunal School ERP",
        icon: Calendar,
    ...
    case "marketplace":
      return {
        ...
        cardTitle: "Built by Kunal Market Core",
        icon: Coins,
    ...
    case "pos":
      return {
        ...
        cardTitle: "Built by Kunal Cloud POS",
        icon: Settings,
    ...
    case "crm":
      return {
        ...
        cardTitle: "Built by Kunal CRM Panel",
        icon: MessageSquare,
        wideGradient: "from-[#DB2777] to-[#EC4899]",
        squareGradient: "from-[#5B21B6] to-[var(--accent-global)]"
      };
    case "logistics":
      return {
        ...
        cardTitle: "Built by Kunal Logistics",
        icon: Globe,
    ...
    case "inventory":
      return {
        ...
        cardTitle: "Built by Kunal Inventory Node",
        icon: Database,
    ...
    case "ecommerce":
      return {
        ...
        cardTitle: "Built by Kunal Commerce Core",
        icon: Coins,
    ...
    case "hrms":
      return {
        ...
        cardTitle: "Built by Kunal HRMS Portal",
        icon: Briefcase,
        wideGradient: "from-[var(--accent-global-hover)] to-[var(--accent-global)]",
    ...
    default:
      return {
        ...
        cardTitle: "Built by Kunal Engine",
        icon: Settings,
        wideGradient: "from-[#1E1B4B] to-[#312E81]",
        squareGradient: "from-[#10B981] to-[#059669]"
      };
...
export default function PremiumCapabilities({ serviceId, serviceTitle, features }: PremiumCapabilitiesProps) {
  ...
  const conversionTabs = [
    ...
    },
    {
      ...
      actionHref: "https://wa.me/917667341075",
      isExternal: true
    },
    {
      ...
      iconColor: "text-[var(--accent-global)]",
      hoverBg: "group-hover:bg-[var(--accent-global)] group-hover:text-white",
  ...
  return (
    <section 
      ...
      style={{
        background: "radial-gradient(ellipse 60% 50% at 50% 0%, rgba(var(--accent-global-rgb), 0.02) 0%, transparent 70%), linear-gradient(180deg, #ffffff 0%, #fcfbff 50%, #ffffff 100%)"
      }}
    >
