        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-20">
          ...
          >
            <span
              ...
              style={{
                background: "var(--accent-global-dim, rgba(var(--accent-global-rgb), 0.10))",
            ...
            >
              How We Deliver{" "}
              <span style={{ color: "var(--accent-global)" }}>Success</span>
              {" "}in 4 Steps
            </h2>
          </motion.div>
          ...
          >
            ...
            <a
              ...
              style={{
                ...
                boxShadow: "0 4px 14px color-mix(in srgb, var(--accent-global) 35%, transparent)",
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  color: "var(--accent-global)",
                  border: "1px solid var(--accent-global)20",
                }}
              >
