        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <div className="block md:hidden space-y-4">
              {[
                { feature: "PAGE LOAD SPEED", traditional: "3.2s – 8s (Frustratingly slow)", builtbykunal: "Sub-second loading" },
                { feature: "MOBILE PERFORMANCE", traditional: "Laggy animations & load delays", builtbykunal: "Fluid & buttery-smooth" },
                { feature: "SEO & GOOGLE SEARCH", traditional: "Restricted template structure", builtbykunal: "First-page optimized" },
                { feature: "TRAFFIC SPIKE CAPACITY", traditional: "Servers crash under sudden load", builtbykunal: "Infinite scale capacity" },
                { feature: "CYBER SECURITY", traditional: "Vulnerable plugins & database leaks", builtbykunal: "100% Hack-proof code" },
                { feature: "DESIGN FREEDOM", traditional: "Restricted by rigid layouts", builtbykunal: "Bespoke customized layouts" },
                { feature: "HOSTING COST & FEES", traditional: "Expensive recurring fees", builtbykunal: "Zero or near-zero cloud fees" }
              ].map((item, idx) => (
                <motion.div
                  key={idx}
