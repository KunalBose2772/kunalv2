        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <div className="block md:hidden space-y-4">
              {[
                { feature: "AUDIENCE TARGETING", traditional: "Broad age/location limits", builtbykunal: "Custom lookalike & pixel audiences" },
                { feature: "CONVERSION TRACKING", traditional: "Likes and page views", builtbykunal: "Server-side purchase tracking" },
                { feature: "AD CREATIVES", traditional: "Single static image", builtbykunal: "Dynamic A/B multivariate testing" },
                { feature: "BUDGET SCALING", traditional: "Guessing and burning cash", builtbykunal: "Scaling only profitable ad sets" },
                { feature: "RETARGETING", traditional: "Non-existent or broken", builtbykunal: "Multi-channel funnel loops" },
                { feature: "PLATFORM ALGORITHM", traditional: "Fighting the algorithm", builtbykunal: "Feeding AI with conversion data" },
                { feature: "REPORTING", traditional: "Confusing dashboard metrics", builtbykunal: "Clear Cost-Per-Acquisition (CPA)" }
              ].map((item, idx) => (
                <motion.div
                  key={idx}
