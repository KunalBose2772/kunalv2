        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <div className="block md:hidden space-y-4">
              {[
                { feature: "SERVER DEPLOYMENT", traditional: "Manual provisioning (Days)", builtbykunal: "Infrastructure as Code (Minutes)" },
                { feature: "TRAFFIC SCALING", traditional: "Hard limits & crashes", builtbykunal: "Elastic Auto-Scaling" },
                { feature: "DATA BACKUPS", traditional: "Manual cron jobs", builtbykunal: "Automated multi-region snapshots" },
                { feature: "SECURITY POSTURE", traditional: "Perimeter firewalls only", builtbykunal: "Zero-trust & VPC isolation" },
                { feature: "COST STRUCTURE", traditional: "Fixed high monthly fees", builtbykunal: "Pay-only-for-what-you-use" },
                { feature: "DISASTER RECOVERY", traditional: "Hours or days to restore", builtbykunal: "Instant automated failovers" },
                { feature: "GLOBAL PERFORMANCE", traditional: "Single datacenter lag", builtbykunal: "Global Edge CDN routing" }
              ].map((item, idx) => (
                <motion.div
                  key={idx}
