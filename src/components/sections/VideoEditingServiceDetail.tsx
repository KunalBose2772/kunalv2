        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <div className="block md:hidden space-y-4">
              {[
                { feature: "VISUAL QUALITY", traditional: "Stock transitions & filters", builtbykunal: "Custom 3D & After Effects motion" },
                { feature: "PRODUCT SHOWCASE", traditional: "Flat 2D images", builtbykunal: "Photorealistic 3D rendering" },
                { feature: "COLOR GRADING", traditional: "Harsh unfiltered lighting", builtbykunal: "Professional DaVinci Resolve grading" },
                { feature: "AUDIO DESIGN", traditional: "Copyrighted TikTok audio", builtbykunal: "Custom licensed SFX & mixing" },
                { feature: "TYPOGRAPHY", traditional: "Basic unreadable fonts", builtbykunal: "Dynamic kinetic typography" },
                { feature: "BRANDING", traditional: "Looks like every other video", builtbykunal: "Tailored to your specific guidelines" },
                { feature: "OUTPUT", traditional: "Low bitrate exports", builtbykunal: "Crisp 4K/8K UHD renders" }
              ].map((item, idx) => (
                <motion.div
                  key={idx}
