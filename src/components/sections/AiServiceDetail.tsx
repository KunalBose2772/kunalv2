...
- Calculated Cost: ₹${estimatedCost.toLocaleString("en-IN")}`;
  ...
  return (
    <div className="min-h-screen text-[var(--text-secondary)] bg-[var(--bg-primary)] relative overflow-hidden" style={customStyles}>
      ...
      {/* ── 2. Head-to-Head Comparison (CMS vs Headless Built by Kunal) ── */}
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6">
          ...
          >
              ...
              >
                ...
                <div className="h-11 flex items-center justify-center pb-3">
                  <div className="text-sm font-black tracking-tight font-sora text-white flex items-center gap-1">
                    builtbykunaltech <span className="font-light text-slate-450">solutions</span>
                  </div>
                </div>
            ...
            <div className="block md:hidden space-y-4">
              {[
                { feature: "DATA PROCESSING", traditional: "Requires structured SQL tables", builtbykunal: "Understands unstructured text" },
                { feature: "USER INTERACTION", traditional: "Rigid web forms and buttons", builtbykunal: "Natural conversational UI" },
                { feature: "DECISION MAKING", traditional: "Pre-programmed if/else trees", builtbykunal: "Adaptive reasoning & context" },
                { feature: "SEARCH & DISCOVERY", traditional: "Exact keyword matching only", builtbykunal: "Semantic vector search (RAG)" },
                { feature: "SCALABILITY", traditional: "Linear human effort required", builtbykunal: "Instant parallel agents" },
                { feature: "CUSTOMER SUPPORT", traditional: "Requires massive human teams", builtbykunal: "24/7 intelligent resolution" },
                { feature: "SYSTEM MAINTENANCE", traditional: "Constant manual code updates", builtbykunal: "Self-improving AI loops" }
              ].map((item, idx) => (
                <motion.div
                  key={idx}
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <style dangerouslySetInnerHTML={{__html:`
              .calc-r::-webkit-slider-thumb{-webkit-appearance:none;width:18px;height:18px;border-radius:50%;background:var(--accent-global);cursor:pointer;box-shadow:0 2px 6px rgba(0,0,0,0.22);transition:transform .15s}
              .calc-r::-webkit-slider-thumb:hover{transform:scale(1.15)}
              .calc-r::-moz-range-thumb{width:18px;height:18px;border:none;border-radius:50%;background:var(--accent-global);cursor:pointer}
              .calc-r::-webkit-slider-runnable-track{background:linear-gradient(to right,var(--accent-global) var(--pct,0%),#e2e8f0 var(--pct,0%));border-radius:999px}
            `}}/>
            ...
            >
              <div className="space-y-4">
                ...
                <div className="rounded-xl border border-white/20 bg-white/10 px-3.5 py-2.5">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-black text-white">KUNAL10</span>
            ...
            >
              ...
              {service.pricing.map((tier, i) => (
                <div
                  ...
                  style={{
                    background: i === 1 ? "var(--accent-global)" : "transparent",
                    fontFamily: "'Sora', sans-serif",
                  }}
                >
                  {tier.tier}
      ...
      <section className="border-t relative overflow-hidden bg-slate-950 border-white/[0.06] pb-0 pt-20" id="contact-project-form">
                ...
                {sent ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <button
                      ...
                      style={{ background: "var(--accent-global)", boxShadow: "0 6px 20px rgba(var(--accent-global-rgb), 0.35)" }}
                    >
        ...
        <div className="relative w-full z-0">
          ...
          <div className="absolute top-6 left-1/2 -translate-x-1/2 z-20 flex items-center gap-2 bg-slate-950/90 backdrop-blur-sm px-5 py-2.5 rounded-full border border-white/[0.14] shadow-xl whitespace-nowrap">
            ...
            <span className="text-xs font-bold text-white tracking-wide" style={{ fontFamily: "'Inter', sans-serif" }}>Built by Kunal — Ranchi, Jharkhand, India</span>
          </div>
          <iframe
            ...
            title="Built by Kunal Office Location"
          />
        </div>
            ...
            <div className="contact-marquee-track text-[52px] sm:text-[80px] md:text-[100px] font-black tracking-tighter uppercase select-none font-sora">
              {[...Array(2)].map((_, i) => (
                <span key={`a${i}`} className="inline-flex items-center gap-6 px-6">
                  ...
                  <span className="text-white/20">·</span>
                  <span className="text-white/90">BUILTBYKUNAL</span>
