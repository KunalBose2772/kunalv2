...
const track1 = [
  {
    ...
    company: "FinanceIQ",
    avatar: "SM",
    content: "Built by Kunal transformed our entire fintech platform in just 4 months. The quality of engineering, attention to detail, and proactive communication was exceptional.",
    date: "2 weeks ago",
  },
  {
    id: "2",
    ...
    company: "MediConnect",
    avatar: "RK",
    content: "Working with Built by Kunal felt like having an extension of our in-house team. They built our healthcare platform from scratch — backend, mobile apps, and AI features — with world-class execution.",
    date: "1 month ago",
  },
  {
    id: "3",
    ...
    company: "RetailMax",
    avatar: "ET",
    content: "We needed a complete e-commerce overhaul in a tight timeline. Built by Kunal delivered a next-gen platform handling 2M+ users seamlessly. Their DevOps expertise saved us $200K/year.",
    date: "3 days ago",
  },
  {
    id: "4",
...
const track2 = [
  {
    ...
    company: "EduLearn",
    avatar: "PS",
    content: "Our edtech platform now serves 25,000+ students globally, thanks to Built by Kunal's brilliant engineering. The real-time video infrastructure they built is flawlessly reliable.",
    date: "2 months ago",
  },
  {
    id: "6",
    ...
    avatar: "MV",
    content: "Built by Kunal designed our cyber threat defense backend. Security is top-tier and AWS scalability is flawless. Their engineers are absolute cloud architectural specialists.",
    date: "1 month ago",
  },
  {
    id: "7",
  ...
  },
  {
    ...
    avatar: "AM",
    content: "Launched our subscriber portal on schedule. Stripe integration, auto-invoicing, and sub-accounts work beautifully. The Built by Kunal team is highly recommended for SaaS execution.",
    date: "5 days ago",
  },
];
