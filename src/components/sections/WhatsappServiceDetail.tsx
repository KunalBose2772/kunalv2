        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <div className="block md:hidden space-y-4">
              {[
                { feature: "OPEN RATES", traditional: "20% - 30% (Emails ignored)", builtbykunal: "98% (Almost instantly read)" },
                { feature: "CONVERSATIONAL AI", traditional: "One-way rigid text", builtbykunal: "Interactive natural AI chat" },
                { feature: "RICH MEDIA", traditional: "Plain text or broken MMS", builtbykunal: "HD Images, Videos, & Docs" },
                { feature: "CALL-TO-ACTION", traditional: "Blue links only", builtbykunal: "Interactive reply buttons" },
                { feature: "SPAM FILTERS", traditional: "Blocked by carriers/inboxes", builtbykunal: "Verified business profiles" },
                { feature: "CUSTOMER SUPPORT", traditional: "Forces user to call/email", builtbykunal: "Resolves directly in-chat" },
                { feature: "INTEGRATION", traditional: "Standalone isolated campaigns", builtbykunal: "Deep 2-way CRM sync" }
              ].map((item, idx) => (
                <motion.div
                  key={idx}
