...
const slides = [
  {
    accent: "var(--accent-global)", accentHover: "var(--accent-global-hover)",
    accentAlpha: "rgba(var(--accent-global-rgb), 0.14)",
    glowTop: "radial-gradient(ellipse 55% 55% at 75% 10%, rgba(var(--accent-global-rgb), 0.22) 0%, transparent 70%)",
      ...
      >
        ...
        <AnimatePresence mode="wait">
          <motion.img
            key={currentIndex}
            src={slide.img}
            alt={`Built by Kunal expert — ${slide.label}`}
