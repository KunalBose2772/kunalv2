        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <div className="block md:hidden space-y-4">
              {[
                { feature: "BRAND UNIQUENESS", traditional: "Looks like 100 other brands", builtbykunal: "100% custom vectors & layouts" },
                { feature: "TYPOGRAPHY", traditional: "Default unreadable fonts", builtbykunal: "Carefully paired type scales" },
                { feature: "COLOR SCIENCE", traditional: "Clashing neon palettes", builtbykunal: "Harmonious brand-specific hues" },
                { feature: "SOURCE FILES", traditional: "Flattened low-res JPGs", builtbykunal: "Organized Figma & Adobe files" },
                { feature: "SCALABILITY", traditional: "Pixelates when printed", builtbykunal: "Infinite resolution SVGs" },
                { feature: "FORMATTING", traditional: "One size fits all", builtbykunal: "Platform-specific aspect ratios" },
                { feature: "MESSAGING", traditional: "Text stuffed into corners", builtbykunal: "Strategic visual hierarchy" }
              ].map((item, idx) => (
                <motion.div
                  key={idx}
