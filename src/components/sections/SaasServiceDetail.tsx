        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <div className="block md:hidden space-y-4">
              {[
                { feature: "DATA SEGREGATION", traditional: "Prone to cross-tenant leaks", builtbykunal: "Strict Row-Level Security" },
                { feature: "INFRASTRUCTURE COSTS", traditional: "Expensive to host many users", builtbykunal: "Cost-effective shared infra" },
                { feature: "BILLING INTEGRATION", traditional: "Manual subscription updates", builtbykunal: "Automated Stripe gateways" },
                { feature: "CUSTOM DOMAINS", traditional: "Hardcoded & inflexible", builtbykunal: "Dynamic Edge routing" },
                { feature: "PERMISSIONS (RBAC)", traditional: "Basic admin/user roles", builtbykunal: "Granular team permissions" },
                { feature: "ANALYTICS ENGINE", traditional: "Basic generic dashboards", builtbykunal: "Embedded custom charts" },
                { feature: "SCALING ABILITY", traditional: "Requires entire app rebuilds", builtbykunal: "Infinite horizontal scale" }
              ].map((item, idx) => (
                <motion.div
                  key={idx}
