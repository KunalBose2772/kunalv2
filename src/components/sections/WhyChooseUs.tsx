...
export default function WhyChooseUs() {
  return (
    ...
    >
      ...
      <div className="absolute top-[20%] left-[-10%] w-[45%] h-[45%] bg-[radial-gradient(circle,_rgba(var(--accent-global-rgb), 0.03)_0%,_transparent_70%)] blur-[90px] pointer-events-none z-0" />
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 relative z-10">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 relative">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[110%] h-[110%] bg-[radial-gradient(circle_at_center,_rgba(var(--accent-global-rgb), 0.03)_0%,_transparent_75%)] pointer-events-none z-0" />
            ...
            <div className="relative z-10 w-full rounded-2xl overflow-hidden border border-slate-200 shadow-2xl bg-white">
              <img
                ...
                alt="Built by Kunalnical Excellence"
          ...
          <div className="lg:col-span-6">
            <div className="mb-8">
              ...
              <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight leading-tight mb-4 font-sora">
                Why Global Leaders <span className="text-[var(--accent-global)]">Choose Built by Kunal</span>
              </h2>
