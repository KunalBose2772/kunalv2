    ...
    <svg width={size} height={size} viewBox="0 0 61 61" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="arr1" x1="0.546204" y1="30.5091" x2="60.4725" y2="30.5091" gradientUnits="userSpaceOnUse">
          <stop stopColor="var(--accent-global)" /><stop offset="1" stopColor="#6366F1" />
        </linearGradient>
  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[radial-gradient(circle,_rgba(var(--accent-global-rgb), 0.07)_0%,_transparent_75%)] rounded-full blur-[120px] pointer-events-none z-[0]" />
        ...
        <div ref={wrapRef} className="ra-project3-wrap z-10">
          ...
          <div className="ra-project3-title flex flex-col justify-center">
            <SectionHeader
              ...
              description="Partner with Built by Kunal to transform your product ideas into digital realities."
              align="left"
              theme="dark"
              className="w-[320px]"
            />
