        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <div className="block md:hidden space-y-4">
              {[
                { feature: "CONTENT STRATEGY", traditional: "Random generic quotes", builtbykunal: "Data-driven content pillars" },
                { feature: "VIDEO PRODUCTION", traditional: "Boring corporate slides", builtbykunal: "High-retention vertical reels" },
                { feature: "COMMUNITY", traditional: "Ignoring comments & DMs", builtbykunal: "Active daily engagement" },
                { feature: "PLATFORM FOCUS", traditional: "Cross-posting same formats", builtbykunal: "Native algorithm optimization" },
                { feature: "COPYWRITING", traditional: "Bland AI-generated captions", builtbykunal: "Hook-driven viral hooks" },
                { feature: "REPORTING", traditional: "Vanity follower metrics", builtbykunal: "Revenue & click tracking" },
                { feature: "BRAND VOICE", traditional: "Soulless and corporate", builtbykunal: "Authentic & personality-led" }
              ].map((item, idx) => (
                <motion.div
                  key={idx}
