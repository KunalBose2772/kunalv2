...
export default function Careers({ hideViewAll = false }: { hideViewAll?: boolean }) {
  ...
  return (
    <section className="py-24 border-t relative overflow-hidden text-slate-650 bg-gradient-to-b from-[#fafbfc] to-slate-50 border-slate-200/50" id="careers">
      ...
      <div className="absolute top-1/4 left-[-10%] w-[40%] h-[40%] bg-[radial-gradient(circle,_rgba(var(--accent-global-rgb), 0.02)_0%,_transparent_70%)] blur-[100px] pointer-events-none z-0" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <div className="mt-6 p-6 rounded-2xl bg-white border border-slate-200/80 shadow-sm">
              ...
              <div className="text-[10px] text-slate-450 mt-3 font-semibold">— Senior Engineer, 3 years at Built by Kunal</div>
            </div>
          </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-2 gap-4">
              <div className="relative rounded-2xl overflow-hidden border border-slate-200/80 shadow-2xl aspect-[4/3] group/c1 bg-slate-100">
                <img 
                  ...
                  alt="Built by Kunal Developers Collaboration" 
            ...
            {success ? (
              <div className="text-center py-8 flex flex-col items-center">
                ...
                <p className="text-xs text-slate-500 leading-relaxed max-w-sm">
                  Thank you for applying to Built by Kunal. We review applications within 48 hours and will email you with the next steps if your profile fits.
                </p>
                <button 
                  onClick={closeModal}
