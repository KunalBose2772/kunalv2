        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <div className="block md:hidden space-y-4">
              {[
                { feature: "CODE RELEASES", traditional: "Prone to human error", builtbykunal: "100% automated & consistent" },
                { feature: "TESTING", traditional: "Manual clicks & checks", builtbykunal: "Automated unit & E2E gates" },
                { feature: "ROLLBACKS", traditional: "Panic & manual fixes", builtbykunal: "Instant zero-downtime reverts" },
                { feature: "SCALING", traditional: "Adding servers by hand", builtbykunal: "Kubernetes auto-scaling" },
                { feature: "MONITORING", traditional: "Waiting for users to complain", builtbykunal: "Real-time metrics & alerts" },
                { feature: "ENVIRONMENT SETUP", traditional: "Works on my machine", builtbykunal: "Identical Docker containers" },
                { feature: "SECURITY", traditional: "Reactive patching", builtbykunal: "Automated vulnerability scans" }
              ].map((item, idx) => (
                <motion.div
                  key={idx}
