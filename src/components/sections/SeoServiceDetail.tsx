        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <div className="block md:hidden space-y-4">
              {[
                { feature: "ON-PAGE STRATEGY", traditional: "Keyword stuffing & praying", builtbykunal: "Semantic entity clustering" },
                { feature: "SITE SPEED", traditional: "Installing basic caching plugins", builtbykunal: "Core Web Vitals code refactoring" },
                { feature: "SCHEMA MARKUP", traditional: "Basic Yoast/RankMath tags", builtbykunal: "Custom JSON-LD rich results" },
                { feature: "LINK BUILDING", traditional: "Spammy directory submissions", builtbykunal: "High-DR editorial placements" },
                { feature: "CRAWLABILITY", traditional: "Ignoring 404s & redirect loops", builtbykunal: "Optimized crawl budgets & silos" },
                { feature: "REPORTING", traditional: "Vague traffic screenshots", builtbykunal: "Live Looker Studio ROI dashboards" },
                { feature: "CONTENT", traditional: "Generic AI-generated fluff", builtbykunal: "Expert-led high-intent copy" }
              ].map((item, idx) => (
                <motion.div
                  key={idx}
