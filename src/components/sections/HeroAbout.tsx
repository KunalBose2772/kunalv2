...
export default function HeroAbout() {
  ...
  const width = useTransform(
    ...
    [0, windowHeight * 0.15, windowHeight * 0.8, windowHeight],
    [
      dimensions.heroWidth,
      dimensions.heroWidth,
      dimensions.aboutWidth || dimensions.heroWidth,
      dimensions.aboutWidth || dimensions.heroWidth,
    ],
    { ease: easeInOutQuart }
  );
  ...
  const height = useTransform(
    ...
    [0, windowHeight * 0.15, windowHeight * 0.8, windowHeight],
    [
      dimensions.heroHeight,
      dimensions.heroHeight,
      dimensions.aboutHeight || dimensions.heroHeight,
      dimensions.aboutHeight || dimensions.heroHeight,
    ],
    { ease: easeInOutQuart }
  );
  ...
  return (
    <div ref={containerRef} className="relative w-full bg-[#03050c] text-white">
      {/* ========================================================================= */}
      {/* HERO SECTION */}
      {/* ========================================================================= */}
      <section className="relative h-screen overflow-hidden flex flex-col justify-between hero-blue-glow select-none bg-[#03050c]">
        ...
        <motion.div style={{ opacity: heroBgOpacity }} className="absolute inset-0 pointer-events-none z-0">
          <video
            ...
            muted
            playsInline
            className="absolute inset-0 w-full h-full object-cover opacity-[0.20] mix-blend-screen"
          >
            <source src="/hero.mp4" type="video/mp4" />
          </video>
          <div className="absolute inset-0 hero-grid opacity-[0.03]" />
          <div className="absolute top-[40%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] md:w-[600px] md:h-[600px] rounded-full bg-[var(--accent-global)]/10 blur-[80px] md:blur-[130px]" />
          <div className="absolute top-0 right-0 w-[200px] h-[200px] md:w-[400px] md:h-[400px] rounded-full bg-[var(--accent-global)]/8 blur-[60px] md:blur-[110px]" />
        </motion.div>
        ...
        >
          <span className="font-serif italic font-light text-[clamp(36px,6vw,96px)] text-white/90 tracking-normal block">
            Hey, there
          </span>
        </motion.div>
        ...
        <div className="w-[calc(100%-48px)] max-w-[1480px] mx-auto px-7 z-10 flex-grow flex flex-col justify-between relative h-full pointer-events-none">
          ...
          <div className="hidden lg:block absolute bottom-[10%] left-7 z-30 max-w-[30%] pointer-events-none">
            ...
            >
              <div className="flex items-center gap-3 px-5 py-2.5 rounded-full border border-white/10 bg-black/50 backdrop-blur-md shadow-sm">
            ...
            >
              <span className="font-heading font-black uppercase text-[clamp(28px,6vw,105px)] leading-[0.9] tracking-[-0.04em] text-white">
          ...
          <div className="hidden lg:block absolute bottom-[10%] right-7 z-30 max-w-[30%] text-right pointer-events-none">
            ...
            >
              <p className="text-sm leading-relaxed text-slate-300 font-sans tracking-wide">
            ...
            <motion.div
              ...
              className="flex flex-col"
            >
              <span className="font-heading font-black uppercase text-[clamp(20px,4.5vw,68px)] leading-[0.9] tracking-[-0.04em] text-white">
          ...
          <div className="lg:hidden flex flex-col items-center text-center absolute top-[26%] left-1/2 -translate-x-1/2 w-[calc(100%-48px)] z-30 pointer-events-none">
            <motion.h1
              ...
              className="font-heading font-black uppercase text-[36px] sm:text-[48px] leading-[0.9] tracking-[-0.03em] text-white"
            >
              I AM KUNAL BOSE
            </motion.h1>
            ...
            <motion.h2
              ...
              className="font-heading font-bold uppercase text-[14px] sm:text-[16px] tracking-[0.18em] text-slate-300 mt-3"
            >
            ...
            >
              <Link
                href="/contact"
                className="text-[11px] font-bold tracking-[0.2em] uppercase text-white hover:text-[var(--accent-global)] transition-colors py-2"
              >
                Get in Touch
              </Link>
          ...
          <div className="hidden lg:flex z-30 pt-6 pb-6 w-full flex-row items-center justify-between gap-6 mt-auto">
            ...
            >
              <div className="flex -space-x-2">
                <div className="w-6 h-6 rounded-full bg-slate-700 border border-black overflow-hidden relative">
            ...
            >
              <Link
                href="/contact"
                className="group flex items-center gap-2 text-[11px] font-bold tracking-[0.25em] uppercase text-white hover:text-[var(--accent-global)] transition-all duration-300"
              >
                Get in Touch
      ...
      <section
        id="about"
        className="relative py-20 lg:py-28 bg-[#03050c] border-t border-b border-white/[0.06] z-10 flex items-center overflow-hidden"
      >
        <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[var(--accent-global)]/6 rounded-full blur-[130px] pointer-events-none" />
        <div className="absolute left-0 bottom-0 w-[400px] h-[400px] bg-[var(--accent-global)]/4 rounded-full blur-[100px] pointer-events-none" />
        ...
        <div className="max-w-[1480px] w-full mx-auto px-6 md:px-12 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            >
              <span className="text-[var(--accent-global)] font-semibold tracking-widest uppercase text-xs md:text-sm mb-4 block">
                AVAILABLE FOR FREELANCE & ENTERPRISE
              </span>

              <h2 className="text-[clamp(36px,5vw,64px)] leading-[1.05] font-heading font-bold text-white mb-6 tracking-tight">
                Turning Visionary Ideas
                <br />
                <span className="text-[var(--accent-global)] opacity-90">
                  Into High-Performance Products.
                </span>
              </h2>

              <p className="text-slate-400 text-lg md:text-xl font-medium max-w-xl leading-relaxed">
                I am a full-stack developer and digital systems architect dedicated to building fast, secure, and intuitive web applications that solve real-world problems. Whether you want to launch a new product, automate workflows, or build enterprise platforms, let's collaborate to make it a reality.
              </p>
            </motion.div>
            ...
            <div className="lg:col-span-5 relative w-full flex items-center justify-center pointer-events-none mt-8 lg:mt-0 order-1 lg:order-2">
              ...
              <div className="relative w-full max-w-[240px] sm:max-w-[360px] lg:max-w-[480px] aspect-[4/5] -translate-y-6 md:-translate-y-8">
                ...
                <motion.div
                  ...
                  className="absolute inset-0 -m-8 bg-[var(--accent-global)]/20 blur-[60px] rounded-full pointer-events-none"
                />
      ...
      {dimensions.isReady && (
        ...
        >
          ...
          <div className="absolute inset-0 -z-10 pointer-events-none rounded-full bg-cyan-500/15 blur-[80px]" />

          {/* Interactive Mouse Hover Spotlight Glow placed outside to prevent edge clipping */}
          <div
            className="absolute pointer-events-none rounded-full bg-gradient-to-r from-cyan-500/25 to-blue-500/15 blur-[70px] md:blur-[90px] -z-10"
            style={{
          ...
          <div
            className={`relative w-full h-full cursor-none pointer-events-auto transition-all duration-700 ease-out ${
          ...
          >
            ...
            <motion.div style={{ filter: grayscaleFilter }} className="absolute inset-0">
              <Image
                src="/hero.png"
                alt="Kunal Bose - Developer Portrait"
                fill
                className={`object-contain object-bottom transition-all duration-700 ease-out ${
                  isHovered ? "brightness-[1.05] contrast-[1.03]" : "brightness-[0.95]"
                }`}
                priority
              />
            </motion.div>
      ...
      {/* Fallback image rendered inline inside the Hero section ONLY during hydration */}
      {!dimensions.isReady && (
