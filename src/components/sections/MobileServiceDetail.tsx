        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <div className="block md:hidden space-y-4">
              {[
                { feature: "ANIMATION FRAMERATE", traditional: "Choppy & dropped frames", builtbykunal: "60fps Buttery Smooth" },
                { feature: "OFFLINE CAPABILITY", traditional: "Blank screens without internet", builtbykunal: "Offline-first databases" },
                { feature: "HARDWARE ACCESS", traditional: "Limited camera/GPS access", builtbykunal: "Deep hardware APIs" },
                { feature: "APP STORE APPROVAL", traditional: "High rejection rate by Apple", builtbykunal: "100% Store Compliance" },
                { feature: "USER EXPERIENCE", traditional: "Feels like a generic website", builtbykunal: "Native gesture interactions" },
                { feature: "BATTERY CONSUMPTION", traditional: "Heavy CPU drain", builtbykunal: "Optimized battery usage" },
                { feature: "PUSH NOTIFICATIONS", traditional: "Unreliable delivery", builtbykunal: "Instant reliable delivery" }
              ].map((item, idx) => (
                <motion.div
                  key={idx}
