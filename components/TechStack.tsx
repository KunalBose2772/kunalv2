...
const OpenAiIcon = (props: any) => (
  <svg
    ...
    style={props.style}
  >
    <path d="M21.74 11.04a5.28 5.28 0 0 0-.54-3.13 5.4 5.4 0 0 0-2.32-2.3 5.16 5.16 0 0 0-3.32-.42 5.24 5.24 0 0 0-3.12-1.74 5.37 5.37 0 0 0-4.13.72A5.3 5.3 0 0 0 5.86 6.8a5.2 5.2 0 0 0-1.77 3.1 5.34 5.34 0 0 0 .52 3.16 5.39 5.39 0 0 0 2.3 2.3 5.2 5.2 0 0 0 3.33.4 5.29 5.29 0 0 0 3.14 1.76 5.34 5.34 0 0 0 4.1-.73 5.33 5.33 0 0 0 2.47-2.66 5.22 5.22 0 0 0 1.79-3.09zm-8.8-6.14a3.67 3.67 0 0 1 2.3.8 3.58 3.58 0 0 1 1.25 1.94c-.1.05-.33.15-.5.22l-3.9 2.25a.8.8 0 0 0-.4.7v4.5l-2.6 1.5a.79.79 0 0 1-.4.1.8.8 0 0 1-.4-.1 3.58 3.58 0 0 1-1.42-2.76 3.61 3.61 0 0 1-1.83-3.17c.56-.32 3.14-1.81 3.84-2.18zm-5.46 9.46a3.57 3.57 0 0 1-1.39-1.99 3.63 3.63 0 0 1 .44-2.9c.14.07.41.22.61.34l3.9 2.25a.8.8 0 0 0 .8 0l3.9-2.25v3l-2.6 1.5a.79.79 0 0 1-.8 0l-3.9-2.25v-.69zm3.84 5.2a3.56 3.56 0 0 1-2.29-.8 3.63 3.63 0 0 1-1.25-1.95c.18-.1.49-.28.71-.41l3.9-2.25a.8.8 0 0 0 .4-.69v-4.5l2.6-1.5c.22-.13.48-.19.74-.19a.8.8 0 0 1 .46.15 3.58 3.58 0 0 1 1.42 2.76 3.61 3.61 0 0 1-1.83 3.17c-.57.33-3.15 1.81-3.9 2.26zm3.48-8.9a.8.8 0 0 0-.4-.7l-3.9-2.25v-3l2.6-1.5a.79.79 0 0 1 .8 0l3.9 2.25v.7c.02-.01.02-.01 0 0a3.57 3.57 0 0 1 1.39 1.98 3.63 3.63 0 0 1-.44 2.9l-.61-.34-3.9-2.24zm3.93 2.14c-.22.13-.48.19-.74.19a.8.8 0 0 1-.46-.15 3.58 3.58 0 0 1-1.42-2.76 3.61 3.61 0 0 1 1.83-3.17c.57-.33 3.15-1.82 3.9-2.26a3.56 3.56 0 0 1 2.29.8 3.63 3.63 0 0 1 1.25 1.95c-.18.1-.49.28-.71.41l-3.9 2.25a.8.8 0 0 0-.4.69v4.5l-2.6 1.5zm-5.74-.8l-3.9 2.25v-3l2.6-1.5a.79.79 0 0 1 .8 0l3.9 2.25v-.7c0 .01 0 .01 0 0a3.57 3.57 0 0 1-1.39-1.98 3.63 3.63 0 0 1-.44-2.9l.61.34 3.9 2.24a.8.8 0 0 0 .4.7v4.5l-2.6 1.5a.79.79 0 0 1-.8 0z" />
  </svg>
);
...
const cardsData = [
  ...
  { name: "OpenAI", icon: OpenAiIcon, color: "#A8A8A8", r: 3, c: 9 },
