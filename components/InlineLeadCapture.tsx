...
export default function InlineLeadCapture() {
  ...
  return (
    <section className="relative py-20 lg:py-28 overflow-hidden bg-gradient-to-br from-slate-950 via-[#160b29] to-slate-955 border-b border-white/[0.06] z-10 flex flex-col justify-center" id="lead-form-section">
      ...
      {/* Grid wrapper matching the exact 1480px width and padding of other sections */}
      <div className="max-w-[1480px] w-full mx-auto px-6 md:px-12 relative z-10">
        {/* Consistent 50/50 Grid Split */}
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          
          {/* Left Column (50%) */}
          <div className="lg:col-span-6 space-y-6">
            <div>
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-extrabold uppercase tracking-wider text-[var(--accent-global)] bg-[var(--accent-global-dim)] border border-[var(--accent-global)]/20 mb-4 font-mono">
            ...
            <p className="text-slate-500 text-xs md:text-sm leading-relaxed max-w-md">
              Fill out this quick form and I will get back to you with a free project proposal and quote within 24 hours.
            </p>

            {/* Trust Boxes */}
            <div className="space-y-4 pt-6 border-t border-white/[0.08]">
              {[
                { icon: Clock, title: "24-Hour Response", desc: "No long waiting times. Get a response from me within 24 hours." },
                { icon: Shield, title: "NDA Protected", desc: "Your project specifications and ideas remain completely confidential." },
                { icon: Award, title: "Direct Collaboration", desc: "Speak and collaborate directly with me, your dedicated engineer." }
              ].map((item, idx) => {
                const Icon = item.icon;
                return (
                  <div key={idx} className="flex gap-4 items-start">
                    <div className="w-10 h-10 rounded-xl bg-[var(--accent-global-dim)] border border-[var(--accent-global)]/20 flex items-center justify-center shrink-0 shadow-sm">
                    ...
                    <div className="font-sora">
                      ...
                      <p className="text-[11px] sm:text-xs text-slate-500 leading-relaxed font-light">{item.desc}</p>
                    </div>
                  </div>
                );
              })}
              ...
              {sent ? (
                ...
                >
                  ...
                  <div className="space-y-2">
                    <h3 className="text-2xl font-bold text-slate-950 font-sora tracking-tight">Message Sent! 🎉</h3>
                    <p className="text-xs sm:text-sm text-slate-650 max-w-sm mx-auto leading-relaxed font-sora">
                      I will reach out within 24 hours. I am excited to work with you.
                    </p>
                  </div>
                  {leadId && (
