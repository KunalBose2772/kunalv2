...
/* ── Stats ─────────────────────────────────────────────────────────── */
const stats = [
  { value: "50+", label: "Projects Delivered", sub: "Startups & businesses", icon: BarChart3 },
  { value: "20+", label: "Global Clients", sub: "US, UK, India, UAE", icon: Globe },
  { value: "5+", label: "Years Experience", sub: "Full-stack engineering", icon: Users },
  { value: "4.9★", label: "Client Rating", sub: "Top-rated consultant", icon: Star },
];
...
const slides = [
  {
    ...
    description: "I craft pixel-perfect, performant custom software — from MVPs to enterprise platforms — designed to scale with your business goals.",
    ctaText: "Start Your Project", ctaLink: "#contact",
    secondaryText: "View My Work", secondaryLink: "#work",
    features: ["Full-Stack Engineering", "Clean Architecture", "Rapid Delivery"],
    featureIcons: [Code2, Shield, Zap],
    cardStat: "100%", cardStatLabel: "On-time Delivery",
  ...
  },
  {
    ...
    description: "Unlock predictive insights, smart automation, and natural language interfaces built for custom workflows and scale.",
    ctaText: "Explore AI Solutions", ctaLink: "#contact",
    secondaryText: "Read AI Projects", secondaryLink: "#work",
  ...
  },
  {
    ...
    secondaryText: "See Data Projects", secondaryLink: "#work",
  ...
  },
  {
    ...
    secondaryText: "Cloud Projects", secondaryLink: "#work",
  ...
  },
  {
    ...
    secondaryText: "View Portfolio", secondaryLink: "#work",
      ...
      >
        ...
        <AnimatePresence mode="wait">
          <motion.img
            key={currentIndex}
            src={slide.img}
            alt={`Kunal Bose Expert Developer — ${slide.label}`}
